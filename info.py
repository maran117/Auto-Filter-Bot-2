...
# Bot information
API_ID = environ.get('API_ID', '21911596')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7770517987:AAF4_OVecGW_Ef2IyRmpvcNepquKFAPMaZk')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6594043398')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002457425264').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002189233525')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002280475489')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://maran4486:FWvFrYAyy5ZpbofA@cluster0.1ybqm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002189233525")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://yodelling-donielle-tamilflix-eea74409.koyeb.app/")
if len(URL) == 0:
